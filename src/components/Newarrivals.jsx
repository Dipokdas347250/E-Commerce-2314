...
function SampleNextArrow(props) {
  ...
  function SamplePrevArrow(props) {
    const {  onClick } = props;
    return (
      <div onClick={onClick}  className='h-[60px] w-[60px] bg-[#979797] rounded-full text-center leading-[60px] absolute top-[50%] left-0 translate-y-[-150%] cursor-pointer z-50 duration-300 ease-in-out hover:bg-[#000]'><FaArrowLeft className='inline-block text-[24px] text-white' /></div>
    );
  }
