...
const PaginationArea = ({pageNumber,paginate,currentPages,next,prev}) => {
  ...
  return (
    ...
    <nav aria-label="Page navigation example">
      <ul className="lg:inline-flex -space-x-px text-sm lg:px-0 px-10">
        {pageNumber.length > 0 && 
        ...
        {pageNumber.length > 0 &&
         ...
         <a  className="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 lg:rounded-e-lg  hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
         >
           Next
         </a>
       </li>
